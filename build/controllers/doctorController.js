...
var postInfoDoctors = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _doctorService["default"].saveDetailInfoDoctors(req.body);
        case 3:
  ...
  return function postInfoDoctors(_x5, _x6) {
...
var getScheduleDoctorByDate = /*#__PURE__*/function () {
  ...
  return function getScheduleDoctorByDate(_x11, _x12) {
...
var getExtraInfoDoctorById = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.prev = 0;
          _context7.next = 3;
          return _doctorService["default"].getExtraInfoDoctorById(req.query.doctorId);
        case 3:
          info = _context7.sent;
  ...
  return function getExtraInfoDoctorById(_x13, _x14) {
...
var getListPatientsForDoctor = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          _context9.prev = 0;
          _context9.next = 3;
          return _doctorService["default"].getListPatientsForDoctor(req.query.doctorId, req.query.date);
        case 3:
          info = _context9.sent;
          return _context9.abrupt("return", res.status(200).json(info));
        case 7:
          _context9.prev = 7;
  ...
  return function getListPatientsForDoctor(_x17, _x18) {
