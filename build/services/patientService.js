...
var postPatientBookAppointment = function postPatientBookAppointment(data) {
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            if (!(!data.email || !data.doctorId || !data.timeType || !data.date || !data.lastName || !data.firstName || !data.selectedGender || !data.address || !data.phoneNumber || !data.reason)) {
              _context.next = 5;
              break;
            }
            resolve({
