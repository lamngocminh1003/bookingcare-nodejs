      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return transporter.sendMail({
            from: '"Booking Care" <lamngocminh1003@gmail.com>',
            // sender address
                ...
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    return transporter.sendMail({
                      ...
                      attachments: [{
                        filename: "BookingCare-".concat(dataSend.patientId, "-").concat(new Date().getTime(), ".png"),
...
var getBodyHTMLEmailRemedy = function getBodyHTMLEmailRemedy(dataSend) {
  var result = ' ';
  if (dataSend.language === 'vi') {
    result = "<h3>Xin ch\xE0o ".concat(dataSend.firstName, "! </h3>\n    <p>B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y v\xEC \u0111\xE3 \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh online th\xE0nh c\xF4ng t\u1EA1i Booking care </p>\n    <p>Th\xF4ng tin \u0111\u01A1n thu\u1ED1c/ h\xF3a \u0111\u01A1n c\u1EE7a b\u1EA1n xem t\u1EA1i \u0111\xE2y: </p>\n    <div>Booking care xin ch\xE2n th\xE0nh c\u1EA3m \u01A1n!</div>\n    ");
  }
  if (dataSend.language === 'en') {
    result = "<h3>Dear ".concat(dataSend.firstName, "! </h3>\n    <p>You received this email because you have successfully booked an online medical appointment at Booking care. </p>\n    <p>Your prescription / bill information can be found here: </p>\n    <div>Booking care sincerely thanks!</div>\n    ");
  }
  return result;
};
module.exports = {
